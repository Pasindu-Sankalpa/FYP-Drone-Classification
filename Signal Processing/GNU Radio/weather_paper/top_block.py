...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.osmosdr_sink_0.set_center_freq(ch_freq, 0)
        ...
        self.blocks_vco_c_0 = blocks.vco_c(samp_rate, 6.26e6, 1)
        ...
        self.analog_sig_source_x_0_0 = analog.sig_source_f(samp_rate, analog.GR_SAW_WAVE, 1000, 1.5, 0, 0)
        ...
        self.connect((self.blocks_complex_to_real_0_0, 0), (self.blocks_multiply_xx_0, 1))
        self.connect((self.blocks_multiply_xx_0, 0), (self.blocks_skiphead_0, 0))
        ...
        self.connect((self.blocks_vco_c_0, 0), (self.blocks_complex_to_real_0, 0))
    ...
    def set_ch_freq(self, ch_freq):
        ...
        self.osmosdr_sink_0.set_center_freq(self.ch_freq, 0)
