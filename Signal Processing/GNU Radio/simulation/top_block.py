...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.f_max = f_max = 750e3
        self.delay = delay = 0

        ##################################################
        # Blocks
        ##################################################
        self._freq_range = Range(0, 1000, 50, 500, 2000)
        ...
        self.qtgui_vector_sink_f_0_0 = qtgui.vector_sink_f(
            fft_size,
            -samp_rate*3e6/(8*f_max*freq),
            2*samp_rate*3e6/(8*f_max*freq*fft_size),
            "Distance",
            "",
            "",
            1, # Number of inputs
        ...
        self.qtgui_vector_sink_f_0_0.set_y_axis(-400, 100)
        ...
        self.qtgui_vector_sink_f_0.set_y_axis(-400, 100)
        ...
        self.qtgui_freq_sink_x_0_0.set_y_axis(-400, 100)
        ...
        self.qtgui_freq_sink_x_0.set_y_axis(-400, 100)
        ...
        self.low_pass_filter_0 = filter.fir_filter_fff(
            ...
            firdes.low_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.fft_vxx_0_0_0_1 = fft.fft_vfc(fft_size, True, window.blackmanharris(fft_size), True, 1)
        self.blocks_vco_f_0_0 = blocks.vco_f(samp_rate, 4*3.14*f_max, 1)
        self.blocks_vco_f_0 = blocks.vco_f(samp_rate, 2*3.14*f_max, 1)
        self.blocks_stream_to_vector_0_1 = blocks.stream_to_vector(gr.sizeof_float*1, fft_size)
        self.blocks_nlog10_ff_1 = blocks.nlog10_ff(10, fft_size, 0)
        self.blocks_multiply_xx_0_1 = blocks.multiply_vff(1)
        self.blocks_multiply_xx_0_0 = blocks.multiply_vff(1)
        self.blocks_multiply_xx_0 = blocks.multiply_vff(1)
        self.blocks_delay_0 = blocks.delay(gr.sizeof_float*1, delay)
        self.blocks_complex_to_mag_squared_0 = blocks.complex_to_mag_squared(fft_size)
        self.analog_sig_source_x_0_0 = analog.sig_source_f(samp_rate, analog.GR_TRI_WAVE, freq, 1, 0, 0)
        ...
        # Connections
        ##################################################
        self.connect((self.analog_const_source_x_0, 0), (self.blocks_vco_f_0_0, 0))
        self.connect((self.analog_sig_source_x_0_0, 0), (self.blocks_vco_f_0, 0))
        ...
        self.connect((self.blocks_multiply_xx_0, 0), (self.blocks_multiply_xx_0_1, 1))
        ...
        self.connect((self.blocks_multiply_xx_0_1, 0), (self.qtgui_time_sink_x_1_0_0, 0))
        self.connect((self.blocks_nlog10_ff_1, 0), (self.qtgui_vector_sink_f_0, 0))
        self.connect((self.blocks_nlog10_ff_1, 0), (self.qtgui_vector_sink_f_0_0, 0))
        ...
        self.connect((self.blocks_vco_f_0, 0), (self.blocks_multiply_xx_0_1, 0))
        self.connect((self.blocks_vco_f_0, 0), (self.qtgui_time_sink_x_0, 1))
        self.connect((self.blocks_vco_f_0_0, 0), (self.blocks_multiply_xx_0, 1))
        self.connect((self.blocks_vco_f_0_0, 0), (self.blocks_multiply_xx_0_0, 1))
        self.connect((self.fft_vxx_0_0_0_1, 0), (self.blocks_complex_to_mag_squared_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, self.f_max, 50e3, window.WIN_HAMMING, 6.76))
        self.qtgui_freq_sink_x_0.set_frequency_range(0, self.samp_rate)
        self.qtgui_freq_sink_x_0_0.set_frequency_range(0, self.samp_rate)
        self.qtgui_time_sink_x_0.set_samp_rate(self.samp_rate)
        self.qtgui_time_sink_x_1_0.set_samp_rate(self.samp_rate)
        self.qtgui_time_sink_x_1_0_0.set_samp_rate(self.samp_rate)
        self.qtgui_vector_sink_f_0_0.set_x_axis(-self.samp_rate*3e6/(8*self.f_max*self.freq), 2*self.samp_rate*3e6/(8*self.f_max*self.freq*self.fft_size))
