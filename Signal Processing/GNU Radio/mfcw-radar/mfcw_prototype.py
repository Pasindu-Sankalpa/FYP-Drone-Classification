...
class mfcw_prototype(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "mfcw_prototype", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("mfcw_prototype")
        ...
        self.settings = Qt.QSettings("GNU Radio", "mfcw_prototype")
        ...
        self.carrier_rate = carrier_rate = 2.45e9
        ...
        self.osmosdr_source_0.set_center_freq(2450e6, 0)
        ...
        self.osmosdr_sink_0.set_center_freq(2450e6, 0)
        ...
        self._carrier_rate_range = Range(2.4e9, 2.5e9, 5e6, 2.45e9, 200)
        self._carrier_rate_win = RangeWidget(self._carrier_rate_range, self.set_carrier_rate, "'carrier_rate'", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._carrier_rate_win)
        self._calibrate_range = Range(-100, 100, 1, 0, 200)
        self._calibrate_win = RangeWidget(self._calibrate_range, self.set_calibrate, "'calibrate'", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._calibrate_win)
        ...
        self.connect((self.analog_agc_xx_0, 0), (self.blocks_complex_to_real_0_0, 0))
        ...
        self.connect((self.blocks_complex_to_arg_0, 0), (self.qtgui_histogram_sink_x_0, 0))
        ...
        self.connect((self.blocks_delay_0, 0), (self.analog_agc_xx_0_0, 0))
    ...
    def get_carrier_rate(self):
        return self.carrier_rate

    def set_carrier_rate(self, carrier_rate):
...
def main(top_block_cls=mfcw_prototype, options=None):
