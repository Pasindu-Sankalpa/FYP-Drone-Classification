...
class default(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.qtgui_time_sink_x_1.set_y_axis(-1, 7)
        ...
        for i in range(1):
            ...
            self.qtgui_number_sink_0.set_max(i, 7)
        ...
        self.osmosdr_source_0.set_bandwidth(ch_bw, 0)
        self.blocks_complex_to_mag_squared_0 = blocks.complex_to_mag_squared(1)
        self.analog_probe_avg_mag_sqrd_x_0 = analog.probe_avg_mag_sqrd_f(0, 1)
        ...
        # Connections
        ##################################################
        self.connect((self.analog_agc_xx_0_0, 0), (self.blocks_complex_to_mag_squared_0, 0))
        self.connect((self.blocks_complex_to_mag_squared_0, 0), (self.analog_probe_avg_mag_sqrd_x_0, 0))
        ...
        self.connect((self.osmosdr_source_0, 0), (self.analog_agc_xx_0_0, 0))
    ...
    def set_ch_bw(self, ch_bw):
        self.ch_bw = ch_bw
        self.osmosdr_source_0.set_bandwidth(self.ch_bw, 0)
