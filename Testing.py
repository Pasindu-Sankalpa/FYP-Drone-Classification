...
def eval_comb(drone_names):
    model = torch.load("/home/gevindu/model_final/Saved models/Final_model_comb_v2.pth", map_location=device).eval()
...
if __name__ == "__main__":
    ...
    loader = DataLoader(TestDataSet("20240418_T2_02"), batch_size=16, shuffle=True)
